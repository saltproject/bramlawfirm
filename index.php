	...
	<nav class="fh5co-nav" role="navigation">
		<div class="top-menu">
			<div class="container">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="index.html"><img src="images/logo_b.png" height="80px" width="250px" style="margin-bottom: -55px; margin-top: -66px; margin-left: 15px;";></span></a></div>
					</div>
	...
	<div id="fh5co-about">
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<h2>Our Attorneys</h2>
					<p>Below is a brief professional background of our team members.</p>
				</div>
			</div>
			<div class="row">
